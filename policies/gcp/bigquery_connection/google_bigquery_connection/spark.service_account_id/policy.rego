package terraform.gcp.security.bigquery_connection.google_bigquery_connection.spark.service_account_id
...
conditions := [[
  {
    ...
    "remedies": ["Set spark.spark_history_server_config.dataproc_cluster to the approved cluster"]
  },
  {
    ...
    "values": [
      "projects/my-project-c/regions/australia-southeast2/clusters/approved-cluster"
    ]
  }
]]

package terraform.gcp.security.anthos_on_prem.google_gkeonprem_bare_metal_admin_cluster.control_plane_control_plane_node_pool_config_node_pool_config_operating_system

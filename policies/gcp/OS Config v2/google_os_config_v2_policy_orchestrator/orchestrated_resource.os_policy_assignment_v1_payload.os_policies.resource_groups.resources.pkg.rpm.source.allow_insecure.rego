package terraform.gcp.security.os_config_v2.google_os_config_v2_policy_orchestrator.orchestrated_resource_os_policy_assignment_v1_payload_os_policies_resource_groups_resources_pkg_rpm_source_allow_insecure
...
conditions := [
    [
    {"situation_description" : "Only secure file validation behaviour is allowed for rpm package sources",

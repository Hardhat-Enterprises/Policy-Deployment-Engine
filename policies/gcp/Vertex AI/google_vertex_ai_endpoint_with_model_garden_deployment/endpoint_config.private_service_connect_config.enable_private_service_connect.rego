package terraform.gcp.security.vertex_ai.google_vertex_ai_endpoint_with_model_garden_deployment.endpoint_config.private_service_connect_config.enable_private_service_connect

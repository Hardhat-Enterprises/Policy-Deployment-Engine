    ...
    [
        {
            ...
            "remedies": [
                "Set 'kms_key_name' to a valid CMEK in the format: projects/PROJECT_ID/locations/LOCATION/keyRings/KEY_RING/cryptoKeys/KEY.",
                "Avoid using default Google-managed encryption."
            ]
        },
        {
            ...
            "values": [
                "projects/my-secure-project/locations/global/keyRings/my-keyring/cryptoKeys/my-key"
            ],

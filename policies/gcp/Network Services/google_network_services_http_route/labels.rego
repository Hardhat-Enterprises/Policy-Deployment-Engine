package terraform.gcp.security.network_services.google_network_services_http_route.labels
...
conditions := [
    [
        {
            "situation_description": "The HTTP route's labels do not include an 'environment' key with an approved value. Missing or inconsistent environment labels break environment-based governance and cost/ownership tracking.",
            "remedies": [

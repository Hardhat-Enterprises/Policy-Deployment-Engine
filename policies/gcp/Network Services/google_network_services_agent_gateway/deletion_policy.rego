package terraform.gcp.security.network_services.google_network_services_agent_gateway.deletion_policy
...
conditions := [[
  {
    "situation_description": "Agent Gateway must be protected from accidental deletion.",

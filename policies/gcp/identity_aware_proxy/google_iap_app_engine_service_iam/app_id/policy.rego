package terraform.gcp.security.identity_aware_proxy.google_iap_app_engine_service_iam.app_id 
...
conditions := [
    ...
    "remedies":[ "Something that fixes the issues in this situation","You can have multiple items in the array"]},
    {
        ...
        "attribute_path" : ["app_id"], # An array of strings and indicies eg. ["rsa",0,"key"]
        "values" : ["my-gcp-project"], # Values to compare against

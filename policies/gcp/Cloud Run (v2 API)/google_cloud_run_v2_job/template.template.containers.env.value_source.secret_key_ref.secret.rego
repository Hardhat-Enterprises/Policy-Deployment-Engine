package terraform.gcp.security.cloud_run_v2_api.google_cloud_run_v2_job.template_template_containers_env_value_source_secret_key_ref_secret
...
conditions := [
    ...
    },
    {
        ...
        "attribute_path": ["template",0,"template",0,"containers",0,"env",0,"value_source",0,"secret_key_ref",0,"secret"],
        "values": ["",null],

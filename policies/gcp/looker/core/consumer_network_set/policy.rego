...
conditions := [
  [
    ...
    {
      "condition": "Require consumer network for private connectivity (whitelist: consumerNetwork must be set when private/PSC)",
      "attribute_path": ["consumer_network"],
      "values": ["projects/test-project-123/global/networks/test-vpc"],

package terraform.gcp.security.apigee.google_apigee_data_collector.deletion_policy
import data.terraform.helpers
import data.terraform.gcp.security.apigee.google_apigee_data_collector.vars
conditions := [
    [
        {

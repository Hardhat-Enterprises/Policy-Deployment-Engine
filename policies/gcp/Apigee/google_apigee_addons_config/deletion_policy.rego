package terraform.gcp.security.apigee.google_apigee_addons_config.deletion_policy
    ...
    [
        {
            ...
            "remedies": [
                "Set deletion_policy to PREVENT to block accidental or unauthorized deletion of the addons configuration via terraform destroy"
            ]
        },
        {

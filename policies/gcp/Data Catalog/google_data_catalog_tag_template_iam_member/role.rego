package terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_member.role
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_member.vars

conditions := [
    [
    {"situation_description" : "Data Catalog tag template IAM member uses an over-privileged role.",

package terraform.gcp.security.google_data_catalog.google_data_catalog_entry_group_iam_policy.policy_data

import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_entry_group_iam_policy.vars
...
conditions := [
[
    {"situation_description" : "Data Catalog entry group IAM policy data contains public members.",
...
[
    {"situation_description" : "Data Catalog entry group IAM policy data uses an over-privileged role.",

...
conditions := [
    [
        {
            "situation_description": "The PostgreSQL password reference does not use the latest Secret Manager version, which may prevent centrally rotated credentials from being applied.",
            "remedies": [
        ...
        {
            "condition": "Check whether the PostgreSQL stored-password reference uses the latest Secret Manager version.",
            "attribute_path": [
                "postgresql_profile",
                0,

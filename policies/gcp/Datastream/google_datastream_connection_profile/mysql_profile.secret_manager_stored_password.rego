...
conditions := [
    [
        {
            "situation_description": "The MySQL password reference does not use the latest Secret Manager version, which may prevent centrally rotated credentials from being applied.",
            "remedies": [
        ...
        {
            "condition": "Check whether the MySQL stored-password reference uses the latest Secret Manager version.",
            "attribute_path": [
                "mysql_profile",
                0,

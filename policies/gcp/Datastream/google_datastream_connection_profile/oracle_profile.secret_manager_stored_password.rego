...
conditions := [
    [
        {
            "situation_description": "The Oracle password is not referenced through Google Secret Manager, which may expose the credential or prevent centralised access control, auditing, and rotation.",
            "remedies": [
        ...
        {
            "condition": "Check whether a Secret Manager reference is configured for the Oracle password.",
            "attribute_path": [
                "oracle_profile",
                0,
    ...
    [
        {
            "situation_description": "The Oracle password reference does not follow the required Secret Manager secret-version resource format.",
            "remedies": [
        ...
        {
            "condition": "Check whether the Oracle password reference follows the Secret Manager secret-version resource format.",
            "attribute_path": [
                "oracle_profile",
                0,
                "secret_manager_stored_password"

...
import data.terraform.gcp.security.google_kms.google_kms_key_ring_import_job.import_method.vars as vars

conditions := [

  # Situation 1: Disallow any SHA-1–based import methods
  [
    {
  ...
  # Situation 2: If protection_level == EXTERNAL, require strongest SHA256/AES-256
  [
    {

package terraform.gcp.security.cloud_healthcare.google_healthcare_dicom_store.labels
...
conditions := [
    [
    {"situation_description" : "DICOM Store 'environment' label is not set to an approved value",
    ...
    [
    {"situation_description" : "DICOM Store 'data-classification' label is not set to an approved value",
    ...
    [
    {"situation_description" : "DICOM Store 'compliance' label is not set to an approved value",

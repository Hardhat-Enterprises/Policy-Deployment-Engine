package terraform.gcp.security.cloud_healthcare.google_healthcare_hl7_v2_store.labels
...
conditions := [
    [
    {"situation_description" : "HL7v2 Store 'environment' label is not set to an approved value",
    ...
    [
    {"situation_description" : "HL7v2 Store 'data-classification' label is not set to an approved value",
    ...
    [
    {"situation_description" : "HL7v2 Store 'compliance' label is not set to an approved value",

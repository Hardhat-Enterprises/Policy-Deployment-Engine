package terraform.gcp.security.cloud_healthcare.google_healthcare_fhir_store_iam.member
...
conditions := [
    [
    {"situation_description" : "FHIR Store IAM member must not be allUsers or allAuthenticatedUsers",
    "remedies": [
    ...
    [
    {"situation_description" : "FHIR Store IAM member must not be a project-level identity (projectOwner, projectEditor, projectViewer)",
    "remedies": [

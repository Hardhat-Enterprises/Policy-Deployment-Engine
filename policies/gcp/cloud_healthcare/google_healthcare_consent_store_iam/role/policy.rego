package terraform.gcp.security.cloud_healthcare.google_healthcare_consent_store_iam.role
...
# Primitive roles (owner, editor, viewer) are overly broad and violate
# the principle of least privilege for PHI consent data access.
conditions := [
    [
    {"situation_description" : "Consent Store IAM role must not be a primitive role",
    "remedies": [

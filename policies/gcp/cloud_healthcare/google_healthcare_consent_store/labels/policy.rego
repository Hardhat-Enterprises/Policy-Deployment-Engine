package terraform.gcp.security.cloud_healthcare.google_healthcare_consent_store.labels

import data.terraform.helpers
import data.terraform.gcp.security.cloud_healthcare.google_healthcare_consent_store.vars

# Validate that labels contain required keys with approved values.
# Required labels: environment, owner, data-classification, cost-center, compliance
conditions := [
    [
    {"situation_description" : "Consent store 'environment' label is not set to an approved value",
    ...
    [
    {"situation_description" : "Consent store 'data-classification' label is not set to an approved value",
    ...
    [
    {"situation_description" : "Consent store 'compliance' label is not set to an approved value",

...
conditions := [
    [
    {"situation_description" : "FHIR Store 'environment' label is not set to an approved value",
    ...
    [
    {"situation_description" : "FHIR Store 'data-classification' label is not set to an approved value",
    ...
    [
    {"situation_description" : "FHIR Store 'compliance' label is not set to an approved value",

package terraform.gcp.security.cloud_healthcare.google_healthcare_dicom_store_iam.member
...
conditions := [
    [
    {"situation_description" : "DICOM Store IAM member must not be allUsers or allAuthenticatedUsers",
    "remedies": [
    ...
    [
    {"situation_description" : "DICOM Store IAM member must not be a project-level identity (projectOwner, projectEditor, projectViewer)",
    "remedies": [

package terraform.gcp.security.artifact_registry.google_artifact_registry_repository_iam_binding.role
import data.terraform.helpers
import data.terraform.gcp.security.artifact_registry.google_artifact_registry_repository_iam_binding.vars

conditions := [
  [
  {"situation_description": "Artifact Registry Repository IAM binding must not grant overly broad roles like Owner/Editor",

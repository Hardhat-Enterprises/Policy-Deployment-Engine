package terraform.gcp.security.access_context_manager_vpc_service_controls.google_access_context_manager_service_perimeter_dry_run_ingress_policy.ingress_to_resources
...
conditions := [[
  {
    ...
    "remedies": ["Configure ingress_to.resources with specific project resources instead of '*'."],
  },
  {
    "condition": "Ingress resource targets must not allow all resources.",
    "attribute_path": ["ingress_to", 0, "resources"],
    "values": ["*"],

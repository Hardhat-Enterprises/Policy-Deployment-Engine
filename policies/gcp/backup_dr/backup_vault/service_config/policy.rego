package terraform.gcp.security.backup_dr.service_config.allowed_regions
...
conditions := [
  [
    {
      "situation_description": "Backup DR service config is created in an unapproved region",
      "remedies": [

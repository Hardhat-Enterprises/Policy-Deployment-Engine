...
conditions := [
    [
        {
            "situation_description": "Apigee Organization does not have a Customer Managed Encryption Key (CMEK) configured for API consumer data encryption",
            "remedies": [
        ...
        {
            "condition": "Check if api_consumer_data_encryption_key_name is set",

package terraform.gcp.security.google_dataproc_on_gdc.google_dataproc_gdc_application_environment.spark_application_environment_config_default_version

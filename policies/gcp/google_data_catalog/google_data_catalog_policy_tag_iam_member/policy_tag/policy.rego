package terraform.gcp.security.google_data_catalog.google_data_catalog_policy_tag_iam_member.policy_tag
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_policy_tag_iam_member.vars

conditions := [
    [
    {"situation_description" : "IAM member is attached to an unapproved Data Catalog policy tag.",

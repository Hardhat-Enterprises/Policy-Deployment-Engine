package terraform.gcp.security.google_data_catalog.google_data_catalog_taxonomy_iam_policy.taxonomy
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_taxonomy_iam_policy.vars

conditions := [
    [
    {"situation_description" : "IAM policy is attached to an unapproved Data Catalog taxonomy.",

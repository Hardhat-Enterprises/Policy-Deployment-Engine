package terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_policy.policy_data_members
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_policy.vars

conditions := [
    [
    {"situation_description" : "Data Catalog tag template IAM policy data contains public members.",

package terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_policy.tag_template
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_tag_template_iam_policy.vars

conditions := [
    [
    {"situation_description" : "IAM policy is attached to an unapproved Data Catalog tag template.",

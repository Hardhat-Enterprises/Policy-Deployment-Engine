package terraform.gcp.security.google_data_catalog.google_data_catalog_policy_tag_iam_policy.policy_tag
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_policy_tag_iam_policy.vars

conditions := [
    [
    {"situation_description" : "IAM policy is attached to an unapproved Data Catalog policy tag.",

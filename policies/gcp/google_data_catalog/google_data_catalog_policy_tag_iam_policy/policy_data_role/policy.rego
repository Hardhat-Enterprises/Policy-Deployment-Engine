package terraform.gcp.security.google_data_catalog.google_data_catalog_policy_tag_iam_policy.policy_data_role
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_policy_tag_iam_policy.vars

conditions := [
    [
    {"situation_description" : "Data Catalog policy tag IAM policy data uses an over-privileged role.",

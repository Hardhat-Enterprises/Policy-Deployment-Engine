package terraform.gcp.security.google_data_catalog.google_data_catalog_entry_group_iam_member.entry_group
import data.terraform.helpers
import data.terraform.gcp.security.google_data_catalog.google_data_catalog_entry_group_iam_member.vars

conditions := [
    [
    {"situation_description" : "Data Catalog entry group IAM member is not assigned to an approved entry group.",

...
# is reclassified security_impact: false in docs — schema indexing is a
# functional data-discovery choice, not a security control; this resource has
# no data-classification field to safely gate on sensitivity. Left in place
# and still enforced because Service/ branches cannot delete files; a senior
# team member should remove this file and its fixtures on a chore/ branch.
conditions := [
    [
        {

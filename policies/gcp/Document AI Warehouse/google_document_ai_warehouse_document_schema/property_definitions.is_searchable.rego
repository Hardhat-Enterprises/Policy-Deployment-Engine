...
# security_impact: false in docs — it controls retrieval/indexing behaviour, not
# access control; document access is governed by IAM/warehouse-level permissions
# elsewhere. Left in place and still enforced because Service/ branches cannot
# delete files; a senior team member should remove this file and its fixtures on
# a chore/ branch.
conditions := [
    [
        {

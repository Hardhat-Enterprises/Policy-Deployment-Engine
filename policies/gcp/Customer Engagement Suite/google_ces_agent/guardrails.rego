...
conditions := [
    ...
    "remedies":["Configure the agent with an approved guardrail."]},
    {
        "condition": "Guardrails must use approved guardrail resources.",
        "attribute_path" : ["guardrails"],
        "values" : ["projects/example-project/locations/australia-southeast1/apps/example-app/guardrails/approved-guardrail"], 

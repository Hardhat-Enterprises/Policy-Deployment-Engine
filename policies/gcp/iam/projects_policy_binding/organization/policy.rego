package terraform.gcp.security.iam.organizations_policy_binding.organization# Edit here 
...
scenarios_list:= [
    ...
    [
        { 
            "situation_description" : "unsupported organization", # name/descriptiopn of the scenario
            "remedies": [
                "Please choose from an approved organization!"
            ] # fix messages
        },
        {
            "condition" : "c1: unsupported organization", # condition name
            "attribute_path" : ["organization"], # nested path
            "values" : ["org-c", "org-c-1", "org-c-2"],

package terraform.gcp.security.iam.access_boundary_policy.rules.access_boundary_rule.availability_condition.expression # Edit here 
...
scenarios_list:= [
    ...
    [
        { 
            ...
            "remedies": ["rules.access_boundary_rule.availability_condition.expression should not be empty and in Common Expression Language"] # fix messages
        },
        {
            "condition" : "c1: empty rules.access_boundary_rule.availability_condition.expression", # condition name
            "attribute_path" : ["rules", 0, "access_boundary_rule", 0, "availability_condition", 0, "expression"], # nested path

package terraform.gcp.security.iam.access_boundary_policy.rules.access_boundary_rule.availability_condition.description # Edit here 
...
scenarios_list:= [
    ...
    [
        { 
            "situation_description" : "empty rules.access_boundary_rule.availability_condition.description", # name/description of the scenario
            "remedies": ["rules.access_boundary_rule.availability_condition.description should not be empty"] # fix messages
        },
        {
            "condition" : "c1: empty rules.access_boundary_rule.availability_condition.description", # condition name
            "attribute_path" : ["rules", 0, "access_boundary_rule", 0, "availability_condition", 0, "description"], # nested path

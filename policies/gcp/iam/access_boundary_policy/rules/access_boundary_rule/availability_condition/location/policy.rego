package terraform.gcp.security.iam.access_boundary_policy.rules.access_boundary_rule.availability_condition.location # Edit here 
...
scenarios_list:= [
    ...
    [
        { 
            ...
            "remedies": ["rules.access_boundary_rule.availability_condition.location should not be empty; should be informative for debugging"] # fix messages
        },
        {
            "condition" : "c1: empty rules.access_boundary_rule.availability_condition.location", # condition name
            "attribute_path" : ["rules", 0, "access_boundary_rule", 0, "availability_condition", 0, "location"], # nested path

...
scenarios_list:= [
    ...
    [
        { 
            "situation_description" : "unapproved target.principal_set cloudresourcemanager folder id/num", 
            "remedies": [
                "Currently 'target.principal_set cloudresourcemanager should contain approved folder id/num!"
            ]
        },
        {
        ...
        {
            "condition" : "c2: unapproved folder id/num.",
            "attribute_path" : ["target", 0, "principal_set"], 
            "values" : ["//cloudresourcemanager[.]googleapis[.]com/folders/*", [["folder-id-1", "folder-num-1"]]],
            "policy_type" : "pattern whitelist"
        }
    ],
    [
        ...
        {
            "condition" : "c2: unapproved folder id, location, and workloadIdentityPool_id",
            "attribute_path" : ["target", 0, "principal_set"], 
            "values" : ["//iam[.]googleapis[.]com/folders/*/locations/*/workloadIdentityPools/*", [["folder-id-1", "folder-id-2"], ["location-1", "location-2"], ["wip_id-1", "wip_id-2"]]],
            "policy_type" : "pattern whitelist"
        }
    ],
]

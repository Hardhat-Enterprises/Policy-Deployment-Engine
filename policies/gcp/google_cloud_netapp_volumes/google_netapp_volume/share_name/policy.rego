package terraform.gcp.security.google_cloud_netapp_volumes.google_netapp_volume.share_name # Edit here 
...
conditions := [
    ...
    "remedies":[ "Something that fixes the issues in this situation","You can have multiple items in the array"]},
    {
        ...
        "attribute_path" : ["share_name"], # An array of strings and indicies eg. ["rsa",0,"key"]
        "values" : ["test-volume"], # Values to compare against

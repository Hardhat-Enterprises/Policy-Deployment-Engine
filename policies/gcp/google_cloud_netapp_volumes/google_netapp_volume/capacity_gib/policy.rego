package terraform.gcp.security.google_cloud_netapp_volumes.google_netapp_volume.capacity_gib # Edit here 
...
conditions := [
    ...
    "remedies":[ "Something that fixes the issues in this situation","You can have multiple items in the array"]},
    {
        ...
        "attribute_path" : ["capacity_gib"], # An array of strings and indicies eg. ["rsa",0,"key"]
        "values" : ["100"], # Values to compare against

package terraform.gcp.security.Cloud_Stackdriver_Logging.bucket_config.index_config_policy
...
conditions := [
    ...
    # Index configuration field validation
    [
        {
    ...
    # Index configuration type validation
    [
        {
    ...
    [
        ...
        },
        {
            ...
            "values": [10, null],  # Max 10 indexed fields, no minimum
            "policy_type": "range"
        }
    ]

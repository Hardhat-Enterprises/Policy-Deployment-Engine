package terraform.gcp.security.gke_backup.restore_plan.australian_region_restriction

import data.terraform.gcp.helpers
import data.terraform.gcp.security.gke_backup.restore_plan.vars

# Policy to ensure restore plans are created in Australian regions only
situations := [
    [
        {
            "situation_description": "GKE restore plans must be created in Australian regions for compliance",

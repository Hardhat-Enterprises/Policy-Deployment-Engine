...
conditions := [
  [
    {
      "situation_description": "Consent store 'environment' label is missing or not an approved value",
      "remedies": [
  ...
  [
    {
      "situation_description": "Consent store 'owner' label is missing or empty",
      "remedies": [

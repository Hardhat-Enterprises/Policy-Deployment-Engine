...
conditions := [
  [
    {
      "situation_description": "Healthcare Workspace 'environment' label is missing or not an approved value",
      "remedies": [
  ...
  [
    {
      "situation_description": "Healthcare Workspace 'owner' label is missing or empty",
      "remedies": [

...
conditions := [
  [
    {
      "situation_description": "Healthcare Pipeline Job 'environment' label is missing or not an approved value",
      "remedies": [
  ...
  [
    {
      "situation_description": "Healthcare Pipeline Job 'owner' label is missing or empty",
      "remedies": [

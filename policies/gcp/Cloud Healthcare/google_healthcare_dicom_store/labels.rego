...
conditions := [
  [
    {
      "situation_description": "DICOM Store 'environment' label is missing or not an approved value",
      "remedies": [
  ...
  [
    {
      "situation_description": "DICOM Store 'owner' label is missing or empty",
      "remedies": [

package terraform.gcp.security.oracle_database.cloud_vm_cluster.properties_diagnostics_data_collection_options_diagnostics_events_enabled
import data.terraform.helpers
import data.terraform.gcp.security.oracle_database.cloud_vm_cluster.vars
...
conditions := [
    ...
    "remedies":[ "Set properties.diagnostics_data_collection_options.diagnostics_events_enabled to false unless diagnostic event collection is explicitly required and its output is securely handled"]},
    {
        ...
        "attribute_path" : ["properties", "diagnostics_data_collection_options", "diagnostics_events_enabled"],
        "values" : [false],

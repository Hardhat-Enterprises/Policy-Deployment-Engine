...
# Use 'opa eval ... "data.terraform.gcp.security.google_oracle_database_cloud_vm_cluster.properties_diagnostics_data_collection_options_incident_logs_enabled.message"
message := helpers.get_multi_summary(conditions, vars.variables).message

# Displays a detailed summary of each resources compliance to every condition and situation
# Useful for debugging
# Use 'opa eval ... "data.terraform.gcp.security.google_oracle_database_cloud_vm_cluster.properties_diagnostics_data_collection_options_incident_logs_enabled.details"

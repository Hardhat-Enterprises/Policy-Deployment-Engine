package terraform.gcp.security.deploy.google_clouddeploy_delivery_pipeline.serial_pipeline_stages_strategy_canary_custom_canary_deployment_phase_configs_analysis_custom_checks_task_container_args
...
conditions := [
    [
        ...
        },
        {
            ...
            "attribute_path": ["serial_pipeline", 0, "stages", 0, "strategy", 0, "canary", 0, "custom_canary_deployment", 0, "phase_configs", 0, "analysis", 0, "custom_checks", 0, "task", 0, "container", 0, "args"],
            "values": ["invalid-arg"],

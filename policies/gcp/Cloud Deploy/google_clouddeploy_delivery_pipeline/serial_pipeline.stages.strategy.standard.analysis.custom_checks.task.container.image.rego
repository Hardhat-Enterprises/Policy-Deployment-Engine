package terraform.gcp.security.deploy.google_clouddeploy_delivery_pipeline.serial_pipeline_stages_strategy_standard_analysis_custom_checks_task_container_image
...
conditions := [
    [
        ...
        },
        {
            ...
            "attribute_path": ["serial_pipeline", 0, "stages", 0, "strategy", 0, "standard", 0, "analysis", 0, "custom_checks", 0, "task", 0, "container", 0, "image"],

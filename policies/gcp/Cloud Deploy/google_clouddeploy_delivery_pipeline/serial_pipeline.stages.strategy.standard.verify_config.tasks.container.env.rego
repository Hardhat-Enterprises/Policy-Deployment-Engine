package terraform.gcp.security.deploy.google_clouddeploy_delivery_pipeline.serial_pipeline_stages_strategy_standard_verify_config_tasks_container_env
...
conditions := [
    [
        ...
        },
        {
            ...
            "attribute_path": ["serial_pipeline", 0, "stages", 0, "strategy", 0, "standard", 0, "verify_config", 0, "tasks", 0, "container", 0, "env"],

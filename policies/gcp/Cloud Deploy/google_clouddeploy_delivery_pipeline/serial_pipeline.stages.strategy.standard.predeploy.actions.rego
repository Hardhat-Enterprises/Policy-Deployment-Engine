package terraform.gcp.security.deploy.google_clouddeploy_delivery_pipeline.serial_pipeline_stages_strategy_standard_predeploy_actions
...
conditions := [
    [
        ...
        },
        {
            ...
            "attribute_path": ["serial_pipeline", 0, "stages", 0, "strategy", 0, "standard", 0, "predeploy", 0, "actions"],

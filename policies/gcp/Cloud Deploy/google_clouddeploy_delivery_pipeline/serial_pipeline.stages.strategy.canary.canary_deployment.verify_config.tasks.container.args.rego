package terraform.gcp.security.deploy.google_clouddeploy_delivery_pipeline.serial_pipeline_stages_strategy_canary_canary_deployment_verify_config_tasks_container_args
...
conditions := [
    [
        ...
        },
        {
            ...
            "attribute_path": ["serial_pipeline", 0, "stages", 0, "strategy", 0, "canary", 0, "canary_deployment", 0, "verify_config", 0, "tasks", 0, "container", 0, "args"],
            "values": ["invalid-arg"],

package terraform.gcp.security.dataflow.google_dataflow_flex_template_job.kms_key_name
...
conditions := [
    [
        {
            "situation_description": "Dataflow Flex Template job does not use a customer-managed encryption key (CMEK) for data encryption.",

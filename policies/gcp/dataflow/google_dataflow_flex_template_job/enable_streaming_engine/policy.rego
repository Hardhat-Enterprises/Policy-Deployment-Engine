package terraform.gcp.security.dataflow.google_dataflow_flex_template_job.enable_streaming_engine
...
conditions := [
    [
        {
            "situation_description": "Dataflow Flex Template job does not have Streaming Engine enabled, increasing the number of worker VMs and persistent disks required.",

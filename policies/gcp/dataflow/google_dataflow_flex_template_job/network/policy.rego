package terraform.gcp.security.dataflow.google_dataflow_flex_template_job.network
...
conditions := [
    [
        {
            "situation_description": "Dataflow Flex Template job uses the default VPC network which lacks proper firewall rules and network segmentation.",

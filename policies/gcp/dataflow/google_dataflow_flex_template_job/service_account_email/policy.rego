package terraform.gcp.security.dataflow.google_dataflow_flex_template_job.service_account_email
...
conditions := [
    [
        {
            "situation_description": "Dataflow Flex Template job does not specify a dedicated service account, defaulting to the Compute Engine default SA which has overly broad permissions.",

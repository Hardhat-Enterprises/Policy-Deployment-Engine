package terraform.gcp.security.database_migration_service.google_database_migration_service_connection_profile.oracle_ssl_client_key
...
message := [
    "Situation 1: oracle.ssl.client_key is not configured.",
    sprintf("Non-Compliant Resources: %s", [concat(", ", violating_resources)]),
    "Potential Remedies: Set oracle.ssl.client_key to support SSL verification or client certificate authentication.",
] if {

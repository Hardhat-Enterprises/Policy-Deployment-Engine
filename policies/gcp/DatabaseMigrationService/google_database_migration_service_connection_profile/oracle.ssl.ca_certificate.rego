package terraform.gcp.security.database_migration_service.google_database_migration_service_connection_profile.oracle_ssl_ca_certificate
...
message := [
    "Situation 1: oracle.ssl.ca_certificate is not configured.",
    sprintf("Non-Compliant Resources: %s", [concat(", ", violating_resources)]),
    "Potential Remedies: Set oracle.ssl.ca_certificate to support SSL verification or client certificate authentication.",
] if {

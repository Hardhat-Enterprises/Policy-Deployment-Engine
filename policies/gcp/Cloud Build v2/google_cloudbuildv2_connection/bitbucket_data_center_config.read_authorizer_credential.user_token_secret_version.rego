package terraform.gcp.security.cloudbuildv2.google_cloudbuildv2_connection.bitbucket_data_center_config_read_authorizer_credential_user_token_secret_version
...
conditions := [
    [
        {
            "situation_description": "Ensure Bitbucket Data Center read authorizer credential user token secret version uses the required Secret Manager format",

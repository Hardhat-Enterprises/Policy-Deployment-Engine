package terraform.gcp.security.integration_connectors.google_integration_connectors_connection.auth_config_oauth2_client_credentials_client_secret_secret_version
...
conditions := [
  [
    ...
    {
      "condition": "auth_config.oauth2_client_credentials.client_secret.secret_version must not use the 'latest' alias.",
      "attribute_path": ["auth_config", 0, "oauth2_client_credentials", 0, "client_secret", 0, "secret_version"],
      "values": [

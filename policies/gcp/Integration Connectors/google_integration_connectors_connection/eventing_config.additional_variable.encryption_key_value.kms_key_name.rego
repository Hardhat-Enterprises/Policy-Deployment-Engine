...
conditions := [
  [
    {
      "situation_description": "The eventing variable is not encrypted under a well-formed customer-managed KMS key: either no key is set, or the value is not a KMS key resource name.",
      "remedies": [

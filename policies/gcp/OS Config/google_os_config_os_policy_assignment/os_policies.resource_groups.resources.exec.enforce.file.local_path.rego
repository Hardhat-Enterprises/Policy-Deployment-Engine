package terraform.gcp.security.os_config.google_os_config_os_policy_assignment.os_policies_resource_groups_resources_exec_enforce_file_local_path
...
conditions := [
    ...
    "remedies":["Source local files from an approved directory (e.g. under /opt) to avoid sensitive-path inclusion."]},
    {
        ...
        "attribute_path" : ["os_policies", 0, "resource_groups", 0, "resources", 0, "exec", 0, "enforce", 0, "file", 0, "local_path"],
        "values" : ["/*", [["opt"]]],

...
violating_resources := {resource |
	...
	oauth_configs := object.get(resource.values, ["generic_web_service", 0, "oauth_config"], [])
...
message := [
	...
	"Situation 1: The generic webhook requests missing, wildcard-like, administrative, or known overly broad OAuth scopes",
...
details := [{
	"situation": "The generic webhook requests missing, wildcard-like, administrative, or known overly broad OAuth scopes",

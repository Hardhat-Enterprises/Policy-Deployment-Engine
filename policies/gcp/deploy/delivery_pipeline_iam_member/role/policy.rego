package terraform.gcp.security.deploy.delivery_pipeline_iam_member.role # Edit here 
...
conditions := [
  # Block overly permissive roles in Cloud Deploy Delivery Pipeline IAM member
  [

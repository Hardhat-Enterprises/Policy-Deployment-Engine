...
conditions := [
	[
		{
			"situation_description": "Interconnect group is using ABANDON as its deletion policy.",
			"remedies": [
				"Set deletion_policy to DELETE or PREVENT so the interconnect group stays under Terraform management.",
			],
		},
		{

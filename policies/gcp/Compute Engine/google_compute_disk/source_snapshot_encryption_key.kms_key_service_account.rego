package terraform.gcp.security.compute_engine.google_compute_disk.source_snapshot_encryption_key.kms_key_service_account
import data.terraform.helpers
import data.terraform.gcp.security.compute_engine.google_compute_disk.vars
conditions := [
    [
        {
            "situation_description": "Compute disk uses the default Compute Engine service agent for source snapshot KMS operations rather than a dedicated service account.",

    ...
    [
        {
            ...
            "remedies":  package terraform.gcp.security.compute_engine.google_compute_disk.access_mode
import data.terraform.helpers
import data.terraform.gcp.security.compute_engine.google_compute_disk.vars
conditions := [
    [
...
details := result.details.Groups[1].Value -replace '\.','_' 
        ...
        {
            "condition": "access_mode must be an approved single-attach mode.",
            "attribute_path":  package terraform.gcp.security.compute_engine.google_compute_disk.access_mode
import data.terraform.helpers
import data.terraform.gcp.security.compute_engine.google_compute_disk.vars
conditions := [
    [

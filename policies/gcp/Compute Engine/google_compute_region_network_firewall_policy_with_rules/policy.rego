package terraform.gcp.security.compute_engine.google_compute_region_network_firewall_policy_with_rules.rules # Edit here 
import data.terraform.helpers
import data.terraform.gcp.security.compute_engine.google_compute_region_network_firewall_policy_with_rules.rules.vars
...
conditions := [
    ...
    "remedies":[ "Something that fixes the issues in this situation","You can have multiple items in the array"]},
    {
        ...
        "attribute_path" : ['address'], # An array of strings and indicies eg. ["rsa",0,"key"]
        "values" : ["ABC"], # Values to compare against

package terraform.gcp.security.compute_engine.google_compute_region_network_firewall_policy_with_rules.rule_match_dest_threat_intelligences
...
conditions := [
  [
    ...
    {
      "condition": "Check that destination threat intelligence lists are within the approved set",
      "attribute_path": ["rule", 0, "match", 0, "dest_threat_intelligences"],

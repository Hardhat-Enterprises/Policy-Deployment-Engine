package terraform.gcp.security.contact_center_ai_insights.contact_center_insights_analysis_rule.conversation_filter
...
conditions := [
    [
        {
            "situation_description": "Contact Center Insights Analysis Rule is using an empty or overly broad conversation filter.",
            "remedies": [

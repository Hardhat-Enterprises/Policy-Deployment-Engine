## 🛡️ Policy Deployment Engine: `network_services_edge_cache_origin`

This section provides a concise policy evaluation for the `network_services_edge_cache_origin` resource in GCP.

Reference: [Terraform Registry – network_services_edge_cache_origin](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/network_services_edge_cache_origin)

## 🛡️ Policy Deployment Engine: `network_services_lb_traffic_extension`

This section provides a concise policy evaluation for the `network_services_lb_traffic_extension` resource in GCP.

Reference: [Terraform Registry – network_services_lb_traffic_extension](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/network_services_lb_traffic_extension)

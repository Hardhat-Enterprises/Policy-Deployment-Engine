## 🛡️ Policy Deployment Engine: `eventarc_pipeline`

This section provides a concise policy evaluation for the `eventarc_pipeline` resource in GCP.

Reference: [Terraform Registry – eventarc_pipeline](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/eventarc_pipeline)
...
| `pipeline_id` | The user-provided ID to be assigned to the Pipeline. It should match the format `^[a-z]([a-z0-9-]{0,61}[a-z0-9])?$`. | true | None | None |
| `annotations` | User-defined annotations. See https://google.aip.dev/128#annotations. **Note**: This field is non-authoritative, and will only manage the annotations present in your configuration. Please refer to the field `effective_annotations` for all of the annotations present on the resource. | false | None | None |
| `display_name` | Display name of resource. | false | None | None |
| `crypto_key_name` | Resource name of a KMS crypto key (managed by the user) used to encrypt/decrypt the event data. If not set, an internal Google-owned key will be used to encrypt messages. It must match the pattern "projects/{project}/locations/{location}/keyRings/{keyring}/cryptoKeys/{key}". | false | None | None |
...
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `authentication_config` | Represents a config used to authenticate message requests. Structure is [documented below](#nested_destinations_destinations_authentication_config). | false | None | None |
| `output_payload_format` | Represents the format of message data. Structure is [documented below](#nested_destinations_destinations_output_payload_format). | false | None | None |
| `network_config` | Represents a network config to be used for destination resolution and connectivity. Structure is [documented below](#nested_destinations_destinations_network_config). | false | None | None |
| `http_endpoint` | Represents a HTTP endpoint destination. Structure is [documented below](#nested_destinations_destinations_http_endpoint). | false | None | None |
| `workflow` | The resource name of the Workflow whose Executions are triggered by the events. The Workflow resource should be deployed in the same project as the Pipeline. Format: `projects/{project}/locations/{location}/workflows/{workflow}` | false | None | None |
| `message_bus` | The resource name of the Message Bus to which events should be published. The Message Bus resource should exist in the same project as the Pipeline. Format: `projects/{project}/locations/{location}/messageBuses/{message_bus}` | false | None | None |
| `topic` | The resource name of the Pub/Sub topic to which events should be published. Format: `projects/{project}/locations/{location}/topics/{topic}` | false | None | None |

### input_payload_format Block
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `protobuf` | The format of a Protobuf message payload. Structure is [documented below](#nested_input_payload_format_protobuf). | false | None | None |
| `avro` | The format of an AVRO message payload. Structure is [documented below](#nested_input_payload_format_avro). | false | None | None |
| `json` | The format of a JSON message payload. | false | None | None |

### retry_policy Block
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `max_retry_delay` | The maximum amount of seconds to wait between retry attempts. The value must be between 1 and 600. The default value for this field is 60. | false | None | None |
| `max_attempts` | The maximum number of delivery attempts for any message. The value must be between 1 and 100. The default value for this field is 5. | false | None | None |
| `min_retry_delay` | The minimum amount of seconds to wait between retry attempts. The value must be between 1 and 600. The default value for this field is 5. | false | None | None |

### mediations Block
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `transformation` | Transformation defines the way to transform an incoming message. Structure is [documented below](#nested_mediations_mediations_transformation). | false | None | None |
...
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `google_oidc` | Represents a config used to authenticate with a Google OIDC token using a GCP service account. Use this authentication method to invoke your Cloud Run and Cloud Functions destinations or HTTP endpoints that support Google OIDC. Structure is [documented below](#nested_destinations_destinations_authentication_config_google_oidc). | false | None | None |
| `oauth_token` | Contains information needed for generating an [OAuth token](https://developers.google.com/identity/protocols/OAuth2). This type of authorization should generally only be used when calling Google APIs hosted on *.googleapis.com. Structure is [documented below](#nested_destinations_destinations_authentication_config_oauth_token). | false | None | None |

### google_oidc Block
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `service_account` | Service account email used to generate the OIDC Token. The principal who calls this API must have iam.serviceAccounts.actAs permission in the service account. See https://cloud.google.com/iam/docs/understanding-service-accounts for more information. Eventarc service agents must have roles/roles/iam.serviceAccountTokenCreator role to allow the Pipeline to create OpenID tokens for authenticated requests. | true | None | None |
| `audience` | Audience to be used to generate the OIDC Token. The audience claim identifies the recipient that the JWT is intended for. If unspecified, the destination URI will be used. | false | None | None |

### oauth_token Block
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `service_account` | Service account email used to generate the [OAuth token](https://developers.google.com/identity/protocols/OAuth2). The principal who calls this API must have iam.serviceAccounts.actAs permission in the service account. See https://cloud.google.com/iam/docs/understanding-service-accounts for more information. Eventarc service agents must have roles/roles/iam.serviceAccountTokenCreator role to allow Pipeline to create OAuth2 tokens for authenticated requests. | true | None | None |
...
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `protobuf` | The format of a Protobuf message payload. Structure is [documented below](#nested_destinations_destinations_output_payload_format_protobuf). | false | None | None |
| `avro` | The format of an AVRO message payload. Structure is [documented below](#nested_destinations_destinations_output_payload_format_avro). | false | None | None |
| `json` | The format of a JSON message payload. | false | None | None |

### protobuf Block
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `schema_definition` | The entire schema definition is stored in this field. | false | None | None |

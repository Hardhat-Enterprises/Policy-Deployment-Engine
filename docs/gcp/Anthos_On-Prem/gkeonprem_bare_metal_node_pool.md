...
| `location` | The location of the resource. | true | true | location is a critical security parameter that determines the geographic location of the resource. | us-west1 | asia1 |

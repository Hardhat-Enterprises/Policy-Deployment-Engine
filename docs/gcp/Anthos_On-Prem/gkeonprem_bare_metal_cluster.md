...
| `location` | The location of the resource. | true | true | Location can impact security posture due to regional compliance and data residency requirements. | us-west1 | asia1 |

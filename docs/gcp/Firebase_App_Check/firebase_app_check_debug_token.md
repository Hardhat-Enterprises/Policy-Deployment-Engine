...
|----------|------------|-----------|----------------|-----------|
| `display_name` | A human readable display name used to identify this debug token. | true | None | None |

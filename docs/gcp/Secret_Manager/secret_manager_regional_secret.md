## 🛡️ Policy Deployment Engine: `secret_manager_regional_secret`

This section provides a concise policy evaluation for the `secret_manager_regional_secret` resource in GCP.

Reference: [Terraform Registry – secret_manager_regional_secret](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/secret_manager_regional_secret)

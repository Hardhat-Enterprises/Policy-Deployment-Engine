...
|----------|------------|-----------|----------------|-----------|
| `description` | The description of the export (max of 1024 characters). | true | None | None |
| `dataset` | The dataset to write findings' updates to. Its format is "projects/[projectId]/datasets/[bigquery_dataset_id]". BigQuery Dataset unique ID must contain only letters (a-z, A-Z), numbers (0-9), or underscores (_). | true | None | None |

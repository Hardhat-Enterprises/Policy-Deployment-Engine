## 🛡️ Policy Deployment Engine: `dataproc_cluster_iam`

This section provides a concise policy evaluation for the `dataproc_cluster_iam` resource in GCP.

Reference: [Terraform Registry – dataproc_cluster_iam](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/dataproc_cluster_iam)

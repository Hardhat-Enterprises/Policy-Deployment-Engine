...
### `folder`
- Description: (Required) The parent folder for the PolicyBinding.
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

### `location`
- Description: (Required) The location of the PolicyBinding.
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

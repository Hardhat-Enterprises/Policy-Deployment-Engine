...
| `display_name` | A user-specified display name of the OauthClientCredential. Cannot exceed 32 characters. | false | false | Used for readability and operational clarity only. | Valid Credential | Invalid Credential With Very Long Name Exceeding Limit |

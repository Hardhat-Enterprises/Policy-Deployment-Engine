...
### `principal_set`
- Description: (Optional) Required. Immutable. Full Resource Name of the principal set used for principal access boundary policy bindings. Examples for each one of the following supported principal set types: * Project:
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

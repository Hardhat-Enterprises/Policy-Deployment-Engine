...
| `display_name` | Optional. The description of the policy binding. Must be less than or equal to 63 characters. | false | false | Improves readability and auditability. | None | None |
...
| `title` | Optional. Title for the expression, i.e. a short string describing its purpose. This can be used e.g. in UIs which allow to enter the expression. | false | false | Used only for readability and operational clarity. | None | None |
| `description` | Optional. Description of the expression. This is a longer text which describes the expression, e.g. when hovered over it in a UI. | false | false | Provides human-readable explanation of the CEL condition only. | None | None |
| `location` | Optional. String indicating the location of the expression for error reporting, e.g. a file name and a position in the file. | false | false | Used for debugging and error reporting purposes only. | None | None |

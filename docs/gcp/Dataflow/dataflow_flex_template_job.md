...
| `container_spec_gcs_path` | The GCS path to the Dataflow Flex Template spec file. | true | false | N/A | N/A | N/A |
| `additional_experiments` | List of experiments that should be used by the job. | false | false | N/A | N/A | N/A |
| `additional_pipeline_options` | Additional pipeline options to pass to the Flex Template job. | false | false | N/A | N/A | N/A |
| `autoscaling_algorithm` | The algorithm to allow Dataflow to scale between minWorkers and maxWorkers. | false | false | N/A | N/A | N/A |
...
| `launcher_machine_type` | The machine type to use for launching the job. The default is n1-standard-1. | false | false | N/A | N/A | N/A |
| `machine_type` | The machine type to use for the job. | false | false | N/A | N/A | N/A |
| `max_workers` | The maximum number of Google Compute Engine instances to be made available to your pipeline during execution, from 1 to 1000. | false | false | N/A | N/A | N/A |
...
| `num_workers` | The initial number of Google Compute Engine instances for the job. | false | false | N/A | N/A | N/A |
| `on_delete` | One of 'drain' or 'cancel'. Specifies behavior of deletion during terraform destroy. | false | false | N/A | N/A | N/A |
...
| `sdk_container_image` | Docker registry location of container image to use for the 'worker harness'. Default is the container for the version of the SDK. | false | false | N/A | N/A | N/A |
...
| `staging_location` | The GCS path for staging files. A random subdirectory will be created under the bucket for job staging. | false | false | N/A | N/A | N/A |
...
| `temp_location` | The GCS path for temporary files. A random subdirectory will be created under the bucket for temp data. | false | false | N/A | N/A | N/A |

...
| `location` | Required. Compute Engine location where the instance resides. | true | true | Deploying Apigee instances in non-Australian regions may violate data residency and compliance requirements such as the Australian Privacy Act. All instances must be deployed in approved Australian regions to ensure data sovereignty. | australia-southeast1 | us-east1 |

## 🛡️ Policy Deployment Engine: `compute_ssl_certificate`

This section provides a concise policy evaluation for the `compute_ssl_certificate` resource in GCP.

Reference: [Terraform Registry – compute_ssl_certificate](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_ssl_certificate)

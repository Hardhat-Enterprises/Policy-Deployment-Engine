## 🛡️ Policy Deployment Engine: `compute_target_tcp_proxy`

This section provides a concise policy evaluation for the `compute_target_tcp_proxy` resource in GCP.

Reference: [Terraform Registry – compute_target_tcp_proxy](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_target_tcp_proxy)

## 🛡️ Policy Deployment Engine: `compute_region_per_instance_config`

This section provides a concise policy evaluation for the `compute_region_per_instance_config` resource in GCP.

Reference: [Terraform Registry – compute_region_per_instance_config](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_region_per_instance_config)
...
| `region_instance_group_manager` | The region instance group manager this instance config is part of. | true | None | None |
| `region` | Region where the containing instance group manager is located | false | None | None |

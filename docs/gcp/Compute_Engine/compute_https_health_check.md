## 🛡️ Policy Deployment Engine: `compute_https_health_check`

This section provides a concise policy evaluation for the `compute_https_health_check` resource in GCP.

Reference: [Terraform Registry – compute_https_health_check](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/compute_https_health_check)

...
|----------|------------|-----------|----------------|-----------|
| `access_level` | The name of the Access Level to add this condition to. | true | None | None |
...
| `os_constraints` | A list of allowed OS versions. An empty list allows all types and all versions. Structure is [documented below](#nested_device_policy_os_constraints). | false | None | None |
...
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `vpc_subnetwork` | Sub networks within a VPC network. Structure is [documented below](#nested_vpc_network_sources_vpc_network_sources_vpc_subnetwork). | false | None | None |

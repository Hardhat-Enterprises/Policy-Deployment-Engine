## 🛡️ Policy Deployment Engine: `identity_platform_inbound_saml_config`

This section provides a concise policy evaluation for the `identity_platform_inbound_saml_config` resource in GCP.

Reference: [Terraform Registry – identity_platform_inbound_saml_config](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/identity_platform_inbound_saml_config)
...
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `sp_entity_id` | Unique identifier for all SAML entities. | false | None | None |
| `callback_uri` | Callback URI where responses from IDP are handled. Must start with `https://`. | false | None | None |
...
| Argument | Description | Mandatory | Security Impact | Rationale |
|----------|------------|-----------|----------------|-----------|
| `x509_certificate` | The IdP's x509 certificate. | false | None | None |

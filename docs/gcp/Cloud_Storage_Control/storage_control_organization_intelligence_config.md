...
### `name`
- Description: (Required) Identifier of the GCP Organization. For GCP org, this field should be organization number.
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

### `edition_config`
- Description: (Optional) Edition configuration of the Storage Intelligence resource. Valid values are INHERIT, DISABLED, TRIAL and STANDARD.
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

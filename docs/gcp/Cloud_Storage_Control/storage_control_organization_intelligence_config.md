...
|----------|------------|-----------|----------------|-----------|
| `name` | Identifier of the GCP Organization. For GCP org, this field should be organization number. | true | None | None |
| `edition_config` | Edition configuration of the Storage Intelligence resource. Valid values are INHERIT, DISABLED, TRIAL and STANDARD. | false | None | None |

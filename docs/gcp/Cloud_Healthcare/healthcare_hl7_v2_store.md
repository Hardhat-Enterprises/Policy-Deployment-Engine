...
|----------|------------|-----------|----------------|-----------|
| `name` | The resource name for the Hl7V2Store. ** Changing this property may recreate the Hl7v2 store (removing all data) ** | true | None | None |
...
| `reject_duplicate_message` | Determines whether duplicate messages are allowed. | false | None | None |

...
### `ca_pool`
- Description: (Required) A CA pool resource used to issue interception certificates.
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

### `name`
- Description: (Required) Short name of the TlsInspectionPolicy resource to be created.
- Required: 
- Policy Condition?: 
- Decision / Rationale: 
...
### `location`
- Description: (Optional) The location of the tls inspection policy.
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

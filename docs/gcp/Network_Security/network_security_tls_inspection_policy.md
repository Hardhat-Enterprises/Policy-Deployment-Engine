...
| `exclude_public_ca_set` | If FALSE (the default), use our default set of public CAs in addition to any CAs specified in trustConfig. These public CAs are currently based on the Mozilla Root Program and are subject to change over time. If TRUE, do not accept our default set of public CAs. Only CAs specified in trustConfig will be accepted. | false | None | None |
| `location` | The location of the tls inspection policy. | false | None | None |

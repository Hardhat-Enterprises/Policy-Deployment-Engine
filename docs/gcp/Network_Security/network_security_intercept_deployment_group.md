...
| `intercept_deployment_group_id` | The ID to use for the new deployment group, which will become the final component of the deployment group's resource name. | true | false | None | None | None |

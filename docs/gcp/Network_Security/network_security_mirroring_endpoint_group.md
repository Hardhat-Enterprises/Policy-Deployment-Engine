...
|----------|-------------|----------|-----------------|-----------|-----------|---------------|
| `mirroring_deployment_group` | The deployment group that this DIRECT endpoint group is connected to, for example: `projects/123456789/locations/global/mirroringDeploymentGroups/my-dg`. See https://google.aip.dev/124. | true | false | None | None | None |
| `location` | The cloud location of the endpoint group, currently restricted to `global`. | true | false | None | None | None |
| `mirroring_endpoint_group_id` | The ID to use for the endpoint group, which will become the final component of the endpoint group's resource name. | true | false | None | None | None |
...
| `description` | User-provided description of the endpoint group. Used as additional context for the endpoint group. | false | false | None | None | None |

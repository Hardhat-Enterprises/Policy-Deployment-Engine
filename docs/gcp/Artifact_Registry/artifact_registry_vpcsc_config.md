...
| `location` | The name of the location this config is located in. | false | true | VPC SC location policy whitelists only australia-southeast1 and australia-southeast2. | australia-southeast1 | us-central1 |

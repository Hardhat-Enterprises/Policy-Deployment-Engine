...
### `location`
- Description: (Optional) Location ID of the parent organization. If not provided, 'global' will be used as the default location. <a name="nested_streaming_config"></a>The `streaming_config` block supports:
- Required: 
- Policy Condition?: 
- Decision / Rationale: 

...
|----------|------------|-----------|----------------|-----------|
| `config_id` | This must be unique within the project. | true | None | None |
| `description` | The description of the notification config (max of 1024 characters). | false | None | None |
| `pubsub_topic` | The Pub/Sub topic to send notifications to. Its format is "projects/[project_id]/topics/[topic]". | false | None | None |

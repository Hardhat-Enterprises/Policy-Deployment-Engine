...
| `default_acl` | Configure this ACL to be the default ACL | false | true | role_entity is preferred to manage access instead because it gives fine-grained access controls | None | publicReadWrite |

...
|----------|------------|-----------|----------------|-----------|
| `security_gateways_id` | Part of `parent`. See documentation of `projectsId`. | true | None | None |
| `application_id` | Optional. User-settable Application resource ID. * Must start with a letter. * Must contain between 4-63 characters from `/a-z-/`. * Must end with a number or letter. | true | None | None |

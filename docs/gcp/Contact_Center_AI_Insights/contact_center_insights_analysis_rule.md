...
| `active` | If true, apply this rule to conversations. Otherwise, this rule is inactive and saved as a draft. | true | false | This attribute controls the operational state of the rule and has no direct security impact. | None | None |

...
every resource — which is what docs_v2 needs.
...
Schemas are cached under ``scripts/docgen_v3/.cache/schema_{csp}_{version}.json`` so
...
from scripts.docgen_v2.lib.errors import ConfigurationError, ConnectionError

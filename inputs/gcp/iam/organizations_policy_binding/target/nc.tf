...
resource "google_iam_organizations_policy_binding" "nc" {
  ...
  policy_kind    = "PRINCIPAL_ACCESS_BOUNDARY_UNSUPPORTED"
  policy_binding_id = "binding-for-all-org-principals_nc"
  policy         = "organizations/org-nc/locations/global/principalAccessBoundaryPolicies/principal_access_boundary_policy_id"
  condition {
  ...
  target {
    principal_set = "//iam.googleapis.com/organizations/123456789"
  }
}

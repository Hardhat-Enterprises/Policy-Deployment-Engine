# Assistant responses use an unapproved Model Armor template.
...
resource "google_discovery_engine_assistant" "non_compliant_example_1" {
  ...
  display_name       = "Unapproved response-template assistant"
  ...
  customer_policy {
    model_armor_config {
      ...
      response_template    = "projects/735927692082/locations/eu/templates/unapproved-response-template"

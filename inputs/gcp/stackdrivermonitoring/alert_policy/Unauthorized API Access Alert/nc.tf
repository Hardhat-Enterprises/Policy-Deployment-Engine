# Complete configuration for Unauthorized API Access Alert - NON-COMPLIANT
...
# Unauthorized API Access Alert Policy - NON-COMPLIANT
resource "google_monitoring_alert_policy" "unauthorized_api_access_nc" {
  display_name = "Unauthorized API Access Detected - Non-Compliant"
  project      = google_project.project-nc.project_id
  combiner     = "AND"

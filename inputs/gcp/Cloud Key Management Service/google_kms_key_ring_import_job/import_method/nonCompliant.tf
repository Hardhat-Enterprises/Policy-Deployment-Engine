...
resource "google_kms_key_ring_import_job" "non_compliant_example_1" {
...
resource "google_kms_key_ring_import_job" "non_compliant_example_2" {
  import_job_id    = "non_compliant_example_2"
  key_ring         = "projects/my-project/locations/global/keyRings/my-ring"

resource "google_kms_crypto_key" "compliant_example_1" {
  name            = "c1"
...
resource "google_kms_crypto_key" "compliant_example_2" {
  name            = "c1"
  key_ring        = "example-key-ring"
  purpose         = "ENCRYPT_DECRYPT" # Compliant: purpose is set as approved
...
resource "google_kms_crypto_key" "compliant_example_3" {
  name            = "c2"
  key_ring        = "example-key-ring"

resource "google_cloudbuildv2_connection" "non_compliant_example_1" {
  ...
  github_enterprise_config {
    host_uri                      = "https://bad.example.com"
    app_id                        = 200
    app_slug                      = "gcb-app"
    ...
    service_directory_config {
      service = "projects/my-project-nc/locations/us-central1/namespaces/test-namespace/services/test-service"
    }
  }
}
...
resource "google_cloudbuildv2_connection" "non_compliant_example_2" {
  ...
  github_enterprise_config {
    host_uri                   = "http://untrusted-example.com"
    private_key_secret_version = "projects/my-project-nc/secrets/private-key/versions/1"
    app_id                     = 200
    app_slug                   = "gcb-app"
    app_installation_id        = 300

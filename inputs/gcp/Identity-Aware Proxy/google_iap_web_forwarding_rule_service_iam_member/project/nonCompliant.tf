...
resource "google_iap_web_forwarding_rule_service_iam_member" "non_compliant_example_1" {
...
resource "google_iap_web_forwarding_rule_service_iam_member" "non_compliant_example_2" {
...
resource "google_iap_web_forwarding_rule_service_iam_member" "non_compliant_example_3" {

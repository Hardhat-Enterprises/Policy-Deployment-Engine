...
# The Oracle password references the latest Secret Manager version.
...
resource "google_datastream_connection_profile" "compliant_example_1" {
  ...
  oracle_profile {
    ...
    secret_manager_stored_password = "projects/example-project/secrets/oracle-password/versions/latest"
  }
}

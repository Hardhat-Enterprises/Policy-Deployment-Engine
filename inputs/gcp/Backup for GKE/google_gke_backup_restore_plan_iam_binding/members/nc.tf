resource "google_gke_backup_restore_plan_iam_binding" "nc_g0" {
  name = "nc"
...
resource "google_gke_backup_restore_plan_iam_binding" "nc_g1" {
  name = "nc"
  location = "australia-southeast1"
  project = "PDE"
...
resource "google_gke_backup_restore_plan_iam_binding" "nc_g2" {
  name     = "rp-iam-nc"
  location = "australia-southeast1"
  project  = "PDE"
...
resource "google_gke_backup_restore_plan_iam_binding" "nc_g3" {
  name = "nc"
  location = "australia-southeast1"
  project = "PDE"
...
resource "google_gke_backup_restore_plan_iam_binding" "nc_g4" {
  name = "nc"
  location = "australia-southeast1"
  project = "PDE"
...
resource "google_gke_backup_restore_plan_iam_binding" "nc_g5" {
  name = "nc"
  location = "australia-southeast1"
  project = "PDE"
